...
file {
    "/etc/${::squid3::params::service_name}/allow_regex_domains.txt":
        ...
        source  => 'puppet:///nubis/files/allow_regex_domains.txt',
        require => Class['squid3'];

    "/etc/${::squid3::params::service_name}/allow_domains.txt":
        ensure  => present,
        source  => 'puppet:///nubis/files/allow_domains.txt',
        require => Class['squid3'];

    "/etc/${::squid3::params::service_name}/allow_subnets.txt":
        ensure  => present,
        source  => 'puppet:///nubis/files/allow_subnets.txt',
        require => Class['squid3'];

    "/etc/${::squid3::params::service_name}/deny_domains.txt":
        ensure  => present,
        source  => 'puppet:///nubis/files/deny_domains.txt',
        require => Class['squid3'];

    "/etc/${::squid3::params::service_name}/deny_subnets.txt":
        ensure  => present,
        source  => 'puppet:///nubis/files/deny_subnets.txt',
        require => Class['squid3'];
    ...
    "/etc/confd":
        ...
        owner   => 'root',
        group   => 'root',
        source  => "puppet:///nubis/files/confd-${::squid3::params::service_name}",
        require => Class['squid3'];
